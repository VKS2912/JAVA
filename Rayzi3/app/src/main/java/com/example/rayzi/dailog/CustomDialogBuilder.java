package com.example.rayzi.dailog;
...
public class CustomDialogBuilder {
   ...
   /* public void showSendCoinDialogue(OnCoinDismissListener onCoinDismissListener) {
    ...
    public void showRequestTermDialogue(OnDismissListener onDismissListener) {
        ...
        mBuilder.setContentView(binding.getRoot());
        binding.tvTerm.setOnClickListener(v -> mContext.startActivity(new Intent(mContext, WebViewActivity.class).putExtra("coinType", 0)));
        binding.tvPrivacy.setOnClickListener(v -> mContext.startActivity(new Intent(mContext, WebViewActivity.class).putExtra("coinType", 1)));
        binding.tvPositive.setOnClickListener(v -> {
            mBuilder.dismiss();
            onDismissListener.onPositiveDismiss();
        });
